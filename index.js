...
function displayRandomImage() {
    ...
    fetch("https://apis.scrimba.com/unsplash/photos/random?orientation=landscape&query=nature")
      ...
      .catch(error => {
        ...
        document.body.style.backgroundImage = `url(https://images.unsplash.com/photos/a-very-pretty-blue-and-white-marble-texture-0PPw9irzLIw)`;
        document.getElementById("author").textContent = "By: Aleksandra Khaprenko";
      });
  }
